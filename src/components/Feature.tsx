  ...
  return (
    <section className="features">
      <div className="feature-card">
        ...
        <h3 className="feature-title">Future-proof your firm</h3>
      ...
      <div className="feature-card">
        ...
        <h3 className="feature-title">Host your desktop apps</h3>
        <p className="feature-desc">
      ...
      <div className="feature-card">
        ...
        <h3 className="feature-title">Lock down your apps</h3>
        <p className="feature-desc">
