    ...
    <main className="home">
      <section className="hero">
        ...
        <h1 className="hero-title">
          Hello, <span className="highlight">accounting</span>{" "}
          <span className="gradient-text">awesomeness.</span>
        </h1>
        ...
        <div className="hero-rating">
          <img src={g2Logo} alt="G2 Logo" className="rating-logo" />
          <span className="stars">★★★★★</span>
          <span className="rating-text">4.8 out of 5.0</span>
        </div>
      </section>
      <Features />
      <CaseStudy />
