    ...
    <div className="contact-page">
      ...
      <section className="contact-hero">
        <div className="hero-text">
          ...
          <h1>
            Have questions? <br />
            <span className="highlight">We’re here to help.</span>
          </h1>
        ...
        <div className="hero-image">
          ...
          <img src={contactImage} alt="Support agent" />
        </div>
      </section>
      ...
      <section className="contact-options">
        <div className="contact-card">
          <h3>
            <span className="highlight">New to Rightworks?</span> <br />
            Talk to sales
          </h3>
          <p>
          ...
          <div className="contact-info">
            <p><strong>Phone:</strong> 866.691.4277</p>
            <p><strong>Email:</strong> sales@rightworks.com</p>
          </div>
        ...
        <div className="contact-card">
          <h3>
            <span className="highlight">Already a customer?</span> <br />
          ...
          <div className="contact-info">
            <p><strong>Phone:</strong> 866.691.4277, ext.3</p>
            <p><strong>Billing Email:</strong> billing@rightworks.com</p>
          </div>
      ...
      <section className="consultation">
        ...
        <div className="consultation-cards">
          ...
          <div className="consult-card">
            ...
            <button className="btn-outline">Call 866.691.4277 →</button>
          </div>
        </div>
      </section>
        ...
        <div className="locations-content">
          <div className="locations-list">
            <div className="location active">
              <h4 className="highlight">Nashua, New Hampshire</h4>
              <p>300 Innovative Way, Suite 2340<br/>Nashua, NH 03062</p>
            </div>
            <div className="location">
              <h4>Alpharetta, Georgia</h4>
            </div>
            <div className="location">
