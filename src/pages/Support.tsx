...
import { Cloud, FileText, Shield, Link, Users, Server } from "lucide-react";

const supportItems = [
  {
    icon: <Cloud size={40} className="support-icon" />,
  ...
  {
    icon: <Shield size={40} className="support-icon" />,
    title: "Cloud Protect",
    desc: "Also known as Practice Protect",
    phone: "415-992-8245",
  },
  {
    icon: <Link size={40} className="support-icon" />,
    title: "Connect",
    desc: "Client engagement and business performance tools",
    phone: "866-691-4277 ext. 2",
  },
  {
    icon: <Server size={40} className="support-icon" />,
  ...
  {
    icon: <Users size={40} className="support-icon" />,
    title: "Community",
        ...
        {supportItems.map((item, idx) => (
          <div key={idx} className="support-card">
            ...
            <div className="support-actions">
              <button className="support-btn primary">SUPPORT CENTER</button>
              <button className="support-btn outline">SYSTEM STATUS</button>
              {item.phone && (
