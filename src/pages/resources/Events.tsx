    ...
    <div className="events">
      ...
      <section className="events-header">
        <div className="events-header-content">
          <h1 className="events-title">Rightworks events</h1>
      ...
      <section className="events-filter">
        ...
        <div className="date-wrapper">
          <input type="date" className="date-input" placeholder="Date from" />
          <input type="date" className="date-input" placeholder="Date until" />
        </div>

        {/* Filter Button */}
        <button className="filter-btn">
          FILTER <span className="filter-icon">⚙️</span>
        </button>
      </section>
    </div>
  );
