    ...
    <div className="offers-container">
      ...
      <section className="offers-hero">
        <div className="offers-hero-text">
          <p className="offers-breadcrumb">Partners / Featured offers</p>
          <h1>Featured offers from Rightworks partners</h1>
          <p>
        ...
        <div className="offers-hero-image">
          <img src="/assets/FO1.webp" alt="Rightworks Partner" />
        </div>
      </section>

      {/* Featured offers for accounting firms */}
      <section className="offers-section">
        <h2>Featured offers for accounting firms</h2>
        <p>
        ...
        <div className="offers-grid">
          <div className="offer-card">
            <img src="/assets/FO2.webp" alt="Source Advisors" />
            <h3>Get 10% off Source Advisors’ project fees</h3>
            <p>
          ...
          <div className="offer-card">
            <img src="/assets/FO3.svg" alt="Botkeeper" />
            <h3>Get $100 off Botkeeper</h3>
            <p>
          ...
          <div className="offer-card">
            <img src="/assets/FO5.svg" alt="CPACharge" />
            <h3>Try CPACharge with zero monthly fees</h3>
            <p>
          ...
          <div className="offer-card">
            <img src="/assets/FO6.svg" alt="Bill" />
            <h3>Get 10% off AP & AR automation</h3>
            <p>
          ...
          <div className="offer-card">
            <img src="/assets/FO7.webp" alt="SafeSend" />
            <h3>Automate your tax processes with 10% off</h3>
            <p>
          ...
          <div className="offer-card">
            <img src="/assets/FO8.webp" alt="ADP" />
            <h3>Get 20% off Rightworks Cloud Premier</h3>
            <p>
      ...
      <section className="offers-section">
        <h2>Featured offers for small businesses</h2>
        <p>
          Start running a modern, thriving and secure practice with these
          exclusive, featured offers from Rightworks partners.
        </p>
        <div className="offers-grid">
          <div className="offer-card">
            <img src="/images/bill.png" alt="Bill Free Offer" />
            <h3>Get a free 3-month BILL subscription</h3>
            <p>
              BILL provides a financial operations platform that delivers
              integrated and automated software solutions for AP, AR, and spend
      ...
      <section className="offers-help">
        ...
        <p>
          Give us a call at <a href="tel:8666914291">866.691.4291</a>.
        </p>
        <div className="help-buttons">
          <button className="btn-accounting">Accounting Firms →</button>
          <button className="btn-small">Small Businesses →</button>
        </div>
      </section>
    </div>
  );
