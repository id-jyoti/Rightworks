    ...
    <div className="affiliate">
      ...
      <section className="affiliate-hero">
        <div className="affiliate-hero-text">
          <h1>Share the benefits and reap the rewards... start earning today</h1>
          <button className="apply-btn">APPLY TODAY</button>
        </div>
        <div className="affiliate-hero-image">
          <img src="/assets/AF1.webp" alt="Affiliate Hero" />
        </div>
      </section>
      ...
      <section className="affiliate-program">
        <div className="affiliate-program-image">
          <img src="/assets/AF2.webp" alt="Affiliate Program" />
        </div>
        <div className="affiliate-program-text">
          <h4>Transaction Pro Elite Affiliate Program</h4>
          <h2>Start earning with the Elite Affiliate Program</h2>
          <p>
      ...
      <section className="affiliate-how">
        <div className="affiliate-how-text">
          <h2>How it works</h2>
          <p>As an affiliate partner, you’ll receive:</p>
          <ul>
            <li>✔ A unique URL to use on your website and in upcoming promotions.</li>
            <li>✔ Access to sales promotions on Transaction Pro products.</li>
            <li>✔ Digital assets to help you sell Transaction Pro.</li>
            <li>✔ Up to a 20% referral fee on every purchase made from your unique URL.</li>
          </ul>
        </div>
        <div className="affiliate-how-image">
          <img src="/assets/AF3.webp" alt="How it works" />
        </div>
      </section>
      ...
      <section className="affiliate-faq">
        <div className="faq-container">
          ...
          <div className="faq-right">
            <details open>
              <summary>Is the Elite Affiliate Program free?</summary>
              <p>Yes, the program is free to all approved affiliate partners.</p>
            </details>
            <details>
              <summary>How does this program track sales?</summary>
              <p>Sales are tracked using your unique referral URL.</p>
            </details>
            <details>
              <summary>How much will I earn?</summary>
              <p>You can earn up to 20% referral fee depending on membership level.</p>
            </details>
            <details>
              <summary>How do I get paid?</summary>
              <p>Payments are issued based on tracked sales via your affiliate account.</p>
            </details>
          </div>
        </div>
      </section>
