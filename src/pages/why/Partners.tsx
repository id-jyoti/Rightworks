    ...
    <div className={`partners-page`}>
      ...
      <section className={`hero-section`}>
        ...
        <div className={`hero-image`}>
          <img alt={`Rightworks partnership`}
            src={`/assets/PT1.webp`}
          />
        </div>
      </section>
      ...
      <section className={`why-partner`}>
        ...
        <div className={`why-grid`}>
          <div className={`why-card`}>
            <img alt={`Collaboration`} className={`card-icon`} src={`/assets/icons/P1.svg`}/>
            <h3>
          ...
          <div className={`why-card`}>
            <img alt={`Reach`} className={`card-icon`} src={`/assets/icons/P2.svg`}/>
            <h3>
              {`Expanded reach`}
            </h3>
            <p>
          ...
          <div className={`why-card`}>
            <img alt={`Marketing`} className={`card-icon`} src={`/assets/icons/P3.svg`}/>
            <h3>
          ...
          <div className={`why-card`}>
            <img alt={`Portfolio`} className={`card-icon`} src={`/assets/icons/P4.svg`}/>
            <h3>
              {`Lucrative portfolio expansion`}
            </h3>
            <p>
      ...
      <section className={`featured-offers`}>
        ...
        <div className={`offers-grid`}>
          <div className={`offer-card`}>
            <img alt={`Canopy`} src={`/assets/PT2.svg`}/>
            <h3>
          ...
          <div className={`offer-card`}>
            <img alt={`Botkeeper`} src={`/assets/PT3.svg`}/>
            <h3>
              {`Bookkeeping`}
            </h3>
            <p>
          ...
          <div className={`offer-card`}>
            <img alt={`Source Advisors`} src={`/assets/PT4.webp`}/>
            <h3>
              {`Tax credits, deductions and incentives`}
            </h3>
            <p>
              {`Take advantage of a 10% reduction in project fees.`}
            </p>
            <button>
              {`Learn More →`}
            </button>
