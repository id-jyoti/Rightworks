    ...
    <section className="customers-love-us">
      ...
      <div className="customer-block">
        ...
        <div className="customer-image">
          <img src="/assets/C1.webp" alt="Customers group" />
        </div>
      </div>
      ...
      <div className="customer-block image-left">
        <div className="customer-image">
          <img src="/assets/C2.webp" alt="Customer testimonial" />
        </div>
        <div className="customer-text">
          ...
          <button className="btn-purple">READ CUSTOMER STORIES →</button>
        </div>
      </div>
      ...
      <div className="customer-block">
        <div className="customer-text">
          ...
          <button className="btn-purple">READ REVIEWS →</button>
        </div>
        <div className="customer-image">
          <img src="/assets/C3.webp" alt="Customer review" />
        </div>
      </div>
    </section>
  );
