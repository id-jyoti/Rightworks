    ...
    <div className="reviews-page">
      ...
      <section className="support-section">
        <div className="support-left">
          <p className="small-text">Rightworks customer reviews</p>
          <h1>Unparalleled support, available 24/7</h1>
      ...
      <section className="customer-reviews">
        ...
        <div className="review-card">
          ...
          <div className="review-content">
            <h3>Excellent way to host multi-user Quickbooks Pro</h3>
            <div className="meta">
              <span className="stars">★★★★★</span>
              <span className="date">01/16/2024</span>
            </div>
            <p>
              "Easy for multiple users to access the corporate Quickbooks Pro."
            </p>
            <a href="#">Read the full Rightworks Cloud Hosting review</a>
            <p className="author">Derek H. - Project Manager (Architecture & Planning)</p>
          </div>
        </div>
