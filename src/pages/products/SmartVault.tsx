...
const SmartVault: React.FC = () => {
  return (
    <div className="smartvault-container">
      {/* Hero Section */}
      <section className="smartvault-hero">
        <div className="smartvault-hero-text">
          <p className="smartvault-highlight">Rightworks + SmartVault Accounting Pro</p>
          <h1>Secure, simple document management</h1>
          ...
          <button className="smartvault-cta-btn">Get Started →</button>
        </div>
      </section>
      ...
      <section className="smartvault-security">
        <div className="smartvault-security-content">
          ...
          <div className="smartvault-security-text">
            <p className="smartvault-highlight">Security meets efficiency</p>
            <h2>
              Protect your work with <br />
      ...
      <section className="smartvault-operations">
        <p className="smartvault-highlight">Built for accountants, by accountants</p>
        <h2>
