...
const TotalSecurity: React.FC = () => {
  return (
    <section className="totalsecurity">
      {/* Left Content */}
      <div className="ts-content">
        <h5 className="ts-subtitle">Rightworks Total Security</h5>
        <h1 className="ts-title">
          All-in-one security for <br /> total peace of mind
        </h1>
        <p className="ts-desc">
      ...
      <div className="ts-image">
        <img
          src="/assets/TS1.webp"
          alt="Person using Total Security"
          className="main-img"
        />
