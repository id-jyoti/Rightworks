...
const QuickBooksHosting: React.FC = () => {
    ...
    <>
      ...
      <section className="quickbooks-hosting">
        <div className="quickbooks-hosting-content">
          ...
          <p className="intro">
            Not all QuickBooks hosting is created equal. Our cloud hosting solution, Rightworks Cloud Hosting, has all the security features you need to safely work and collaborate in QuickBooks anytime, anywhere.</p>
        ...
        <div className="quickbooks-hosting-image">
          <img src="../assets/QH1.webp" alt="QuickBooks Hosting Workspace" />
        </div>
      </section>
      ...
      <section className="quickbooks-provider">
        <div className="quickbooks-provider-image">
          <img src="../assets/QH2.webp" alt="Intuit QuickBooks Partner" />
        </div>

        <div className="quickbooks-provider-content">
          <p className="section-subtitle">Proven partnership</p>
      ...
      <section className="quickbooks-features">
        <div className="features-header">
          <p className="features-subtitle">Features & Benefits</p>
        ...
        <div className="features-grid">
          <div className="feature-card">
            <img src="../assets/icons/QH1.svg" alt="Interface Icon" />
          ...
          <div className="feature-card">
            <img src="../assets/icons/QH2.svg" alt="Security Icon" />
          ...
          <div className="feature-card">
            <img src="../assets/icons/QH3.svg" alt="Collaboration Icon" />
          ...
          <div className="feature-card">
            <img src="../assets/icons/QH4.svg" alt="Workflows Icon" />
          ...
          <div className="feature-card">
            <img src="../assets/icons/QH5.svg" alt="Insights Icon" />
          ...
          <div className="feature-card">
            <img src="../assets/icons/QH6.svg" alt="Support Icon" />
      ...
      <section className="quickbooks-demo">
        ...
        <div className="demo-video">
          <img src="../assets/QH3.png" alt="QuickBooks Demo Preview" />
        </div>
      </section>
