    ...
    <>
      ...
      <section className="cloud-premier">
        <div className="cloud-premier-content">
          <p className="tagline">Rightworks Cloud Premier</p>
          <h1>
            Future-proof your firm <br /> with <span>Cloud Premier</span>
          </h1>
          ...
          <div className="cta-buttons">
            <a href="#" className="btn-primary">View Plans →</a>
            <a href="#" className="btn-outline">Get Cloud Premier →</a>
          </div>
        </div>
      ...
      <section className="trusted-tools">
        <p className="trusted-text">Work with the tools you already trust</p>
        <div className="trusted-logos">
          <img src="/assets/logos/A.svg" alt="Thomson Reuters" />
          <img src="/assets/logos/B.svg" alt="Wolters Kluwer" />
          <img src="/assets/logos/C.svg" alt="CCH Access" />
          <img src="/assets/logos/D.svg" alt="Microsoft" />
          <img src="/assets/logos/E.svg" alt="QuickBooks" />
          <img src="/assets/logos/F.svg" alt="Xero" />
          <img src="/assets/logos/G.svg" alt="Bill" />
        </div>
      ...
      <section className="simplify-section">
        <div className="simplify-image">
          <img src="../assets/CP2.webp" alt="Simplify app access" />
        </div>
        <div className="simplify-content">
          <h2>Simplify app access in one safe space</h2>
          <ul>
            <li>
      ...
      <section className="simplify-section">
        <div className="simplify-content">
          <h2>Streamline growth with a platform that scales</h2>
          <ul>
            <li>Hire from anywhere without worry</li>
            <li>Merge firms or add locations without the headaches</li>
            <li>Keep costs under control with predictable monthly pricing</li>
            <li>Get 24/7 support from pros who understand accounting</li>
          </ul>
        </div>
        <div className="simplify-image">
          <img src="../assets/CP3.webp" alt="Simplify app access" />
        </div>
      </section>
      ...
      <section className="simplify-section">
        <div className="simplify-image">
          <img src="../assets/CP4.webp" alt="Simplify app access" />
        </div>
        <div className="simplify-content">
          <h2>Work smarter with tools designed for productivity</h2>
          <ul>
            <li>
              Avoid disruptions and updates during tax season with tools built for accounting workflows 
            </li>
            <li>Onboard new staff quickly and easily</li>
            <li>
              Save time with built-in AI tools designed for secure research and collaboration  
            </li>
            <li>Rely on award-winning support available 24/7</li>
          </ul>
        </div>
      </section>
      ...
      <section className="simplify-section">
        <div className="simplify-content">
          <h2>Protect your firm with next-level security</h2>
          <ul>
            <li>
            ...
            <li>Get advanced threat protection for your Microsoft Exchange email</li>
            <li>
        ...
        <div className="simplify-image">
          <img src="../assets/CP5.webp" alt="Simplify app access" />
        </div>
      </section>
      ...
      <section className="testimonial">
        <div className="testimonial-content">
          ...
          <p className="testimonial-author">
            <strong>Shelly Lingor</strong><br />
