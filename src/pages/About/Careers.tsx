    ...
    <div className="careers-container">
      ...
      <section className="careers-hero">
        <div className="careers-hero-text">
          <h1>
            Making an <br />
            extraordinary impact <br />
            requires <span className="highlight">extraordinary talent.</span>
          </h1>
          <p>
      ...
      <section className="careers-cta">
        <div className="careers-cta-content">
          <h2>Ready to challenge the status quo?</h2>
          <p>
        ...
        <button className="cta-button">VIEW OPENINGS</button>
      </section>

    {/* Section 3 */}
<section className="careers-about">
  <h3 className="section-title">Who we are</h3>
  <h1>Experience our commitment to excellence</h1>
